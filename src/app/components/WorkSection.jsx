  ...
  />
          ...
          <div className="flex items-center">
            ...
            >
              <path
                strokeWidth="2"
                d="M12 8c1.657 0 3 .895 3 2s-1.343 2-3 
                2-3-.895-3-2 1.343-2 3-2zM9 17a3 
                3 0 000 6h6a3 3 0 000-6"
              />
            </svg>

            <h3 className="ml-4 text-3xl font-bold text-gray-900">
              200+ PWD कर्मचारियों की बहाली
            </h3>
          </div>

          <p className="mt-4 text-gray-600 leading-relaxed">
            200+ हटाए गए ठेका कर्मचारियों को पुनः बहाल कराना — 
            यह हमारे मजदूर वर्ग के लिए न्याय और रोजगार सुनिश्चित करने का प्रयास है।
          </p>
